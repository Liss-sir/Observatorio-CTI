    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Perfil Deshabilitado!</h3>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            El perfil <span class="font-semibold text-sena-text-main" id="nombre-perfil-deshabilitado">"Desarrollador Full Stack Senior"</span> ha sido deshabilitado correctamente.
          </p>
          ...
          <div class="mt-4 flex items-center gap-2 text-xs text-sena-text-soft">
            ...
            <span>Esta ventana se cerrará automáticamente en <span id="contador-segundos-deshabilitado">6</span> segundos</span>
          </div>
        </div>
