<div id="modal-deshabilitar-area" class="hidden fixed inset-0 z-50 overflow-y-auto">
  ...
  <div class="fixed inset-0 overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-xl">
        ...
        <div class="px-6 py-4">
          <p class="text-sm">
            ¿Estás seguro de deshabilitar <span class="font-medium">"Nombre del área"</span>? El registro no se eliminará, solo se marcará como inactivo.
          </p>
        </div>
