    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¿Habilitar area?</h3>
            <p class="text-sm text-sena-text-soft">Esta acción activará el Area nuevamente</p>
          </div>
        </div>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            ¿Estás seguro de que deseas habilitar el Area <span class="font-semibold text-sena-text-main" id="nombre-tendencia_actual-habilitar">"Desarrollador Full Stack Senior"</span>?
          </p>
          <p class="text-xs text-sena-text-soft mt-3 bg-yellow-50 p-3 rounded-lg border border-yellow-200">
            <span class="font-medium text-yellow-800">Información:</span> El area volverá a estar visible y disponible para su uso.
          </p>
        </div>
        ...
        <div class="border-t border-sena-border px-6 py-4 flex justify-end gap-3">
          ...
          <button type="button" id="btn-confirmar-habilitar" class="px-4 py-2 text-sm font-medium text-white bg-[#39A900] rounded-lg hover:opacity-90 transition-colors">
