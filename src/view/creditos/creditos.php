      ...
      <section>
        ...
        <div class="max-w-[320px] mx-auto mt-8">
          <div class="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 p-8 text-center featured animate delay-1">
            <img class="w-24 h-24 rounded-full object-cover border-2 border-gray-200 mx-auto mb-4 hover:border-sena-strong transition-all duration-300 hover:scale-105" src="../../assets/img/creadores_img/subdirectora_creador.jpg" alt="Foto de Sandra" />
      ...
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-[900px] mx-auto mt-8 items-stretch">
          <div class="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 p-8 text-center min-h-[260px] animate delay-1">
            ...
            <span class="inline-block mt-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-sena-soft text-sena whitespace-nowrap">Instructora</span>
          ...
          <div class="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 p-8 text-center min-h-[260px] animate delay-2">
            ...
            <span class="inline-flex justify-center items-center mt-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-sena-soft text-sena whitespace-nowrap">Instructor</span>
