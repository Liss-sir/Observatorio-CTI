  ...
  <main class="flex-1 text-sena-text-main">
    ...
    <div class="mb-8">
      ...
      <div class="flex items-start justify-between gap-6 flex-wrap">
        ...
        <!-- Editar -->
        <button data-permiso="editar_linea" id="btn-detalle-editar" type="button" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium border border-sena-border rounded-lg bg-white text-sena-text-main hover:bg-sena-soft transition-colors">
        ...
        <!-- Desactivar -->
        <button data-permiso="desactivar_linea" id="btn-detalle-deshabilitar" type="button" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium border border-[#e65100] rounded-lg bg-white text-[#e65100] hover:bg-[#e65100]/5 transition-colors">
