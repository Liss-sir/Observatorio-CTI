    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-2xl transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-xl transition-all animate-slideDownModal">
        ...
        <div class="border-b border-sena-border px-6 py-4">
          ...
          <p class="mt-1 text-sm text-sena-text-soft">Modifica los datos de la proyección a futuro.</p>
        </div>
        ...
        <form id="form-editar-proyeccion-futuro" class="px-6 py-4">
          ...
          <div class="mb-4">
            ...
            <div class="select-container">
              <select name="area" id="area-proyeccion-editar" class="custom-select w-full rounded-lg border border-sena-border px-3 py-2 text-sm text-sena-text-main focus:border-sena focus:ring-2 focus:ring-sena focus:ring-opacity-20 focus:outline-none">
          ...
          <div class="mb-4">
            ...
            <div class="select-container">
              <select name="anio" id="anio-proyeccion-editar" class="custom-select w-full rounded-lg border border-sena-border px-3 py-2 text-sm text-sena-text-main focus:border-sena focus:ring-2 focus:ring-sena focus:ring-opacity-20 focus:outline-none">
