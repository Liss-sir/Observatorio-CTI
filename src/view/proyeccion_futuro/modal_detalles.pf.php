<!-- modal_detalles.pf.php -->
<!-- Modal para ver detalle de la proyección a futuro -->
<div id="modal-detalle-proyeccion-futuro" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
      ...
      <div class="relative w-full max-w-2xl transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="px-6 py-5">
            ...
            <div>
              ...
              <div class="mt-1">
                <span id="detalle-estado-badge" class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-sena/10 text-sena">
                  ...
                  <span id="detalle-estado-proyeccion_futuro">Activo</span>
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <p class="text-sm text-sena-text-soft mt-1 leading-relaxed" id="detalle-descripcion-proyeccion_futuro">Computación cuántica accesible desde la nube para desarrolladores y empresas, permitiendo experimentación real en problemas de optimización y criptografía.</p>
          </div>
        </div>
