  ...
  <main class="flex-1">
    <div class="max-w-[80rem] mx-auto px-4 py-8 lg:px-8">
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <a href="javascript:history.back()" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-sena rounded-lg whitespace-nowrap h-10 transition-colors">
      ...
      <div class="flex gap-8">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-sm text-sena-text-soft mb-4"><strong class="font-medium text-sena-text-main">5</strong> perfiles encontrados</p>
