<!-- modal_creado_confirmacion.php -->
<!-- Modal de éxito - Perfil creado correctamente (desaparece en 3 segundos) -->
<div id="modal-creado-confirmacion" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Perfil Creado!</h3>
            <p class="text-sm text-sena-text-soft">El perfil se ha creado exitosamente</p>
          </div>
        </div>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            El perfil <span class="font-semibold" style="color: #39A900;" id="nombre-perfil-creado">"Desarrollador Full Stack Senior"</span> ha sido creado correctamente.
          </p>
