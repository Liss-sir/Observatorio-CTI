<!-- modal_confirmacion_crear_te.php -->
<!-- Modal de éxito - tecnología emergente creada correctamente (desaparece en 3 segundos) -->
<div id="modal-creado-confirmacion-tecnologia-emergente" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Tecnología Emergente Creada!</h3>
            <p class="text-sm text-sena-text-soft">La tecnología emergente se ha creado exitosamente</p>
          </div>
        </div>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            La tecnología emergente <span class="font-semibold" style="color: #39A900;" id="nombre-tecnologia-creada">"Desarrollador Full Stack Senior"</span> ha sido creada correctamente.
          </p>
        ...
        <!-- Barra de progreso animada con verde SENA - CORREGIDA -->
        <div class="h-1.5 bg-gray-100 w-full rounded-b-xl overflow-hidden">
          <div id="progress-bar-creado" class="h-full transition-all duration-[3000ms] ease-linear" style="width: 0%; background-color: #39A900;"></div>
        </div>
