<!-- modal_confirmacion_habilitar_te.php -->
<!-- Modal de éxito - tecnología emergente habilitada correctamente (desaparece en 3 segundos) -->
<div id="modal-habilitado-confirmacion-tecnologia" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <!-- Círculo con el verde SENA -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Tecnología Emergente Habilitada!</h3>
