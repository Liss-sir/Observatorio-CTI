<!-- modal_deshabilitar_te.php -->
<div id="modal-deshabilitar-tecnologia-emergente" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-4">
          <h3 class="text-lg font-semibold text-sena-text-main">Deshabilitar Tecnología Emergente</h3>
        </div>

        <!-- Content -->
        <div class="px-6 py-4">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            ¿Estás seguro de deshabilitar <span id="nombre-tecnologia-deshabilitar" class="font-medium  text-[#e65100]">"Desarrollador Full Stack Senior"</span>? 
