<!-- modal_editar_tecnologia_emergente.php -->
<div id="modal-editar-tecnologia-emergente" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-2xl transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-xl transition-all animate-slideDownModal">
        ...
        <div class="border-b border-sena-border px-6 py-4">
          <h3 class="text-lg font-semibold text-sena-text-main">Editar Tecnología Emergente</h3>
          <p class="mt-1 text-sm text-sena-text-soft">Modifica los datos de la tecnología emergente.</p>
        </div>
