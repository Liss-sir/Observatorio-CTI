<!-- modal_confirmacion_habilitar_sug.php -->
<!-- Modal de éxito - sugerencia habilitada correctamente (desaparece en 3 segundos) -->
<div id="modal-habilitado-confirmacion-sugerencia" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <!-- Círculo con el verde SENA -->
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Sugerencia Habilitada!</h3>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            La proyección a futuro <span class="text-sena" id="nombre-proyeccion-habilitado-exito">"Desarrollador Full Stack Senior"</span> ha sido habilitada correctamente.
          </p>
