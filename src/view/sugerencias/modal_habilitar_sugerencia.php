<!-- modal_habilitar_suegerencia.php -->
<!-- Modal de confirmación para habilitar proyección a futuro-->
<div id="modal-habilitar-sugerencia" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-hidden="true">
  <!-- Overlay -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¿Habilitar sugerencia?</h3>
            <p class="text-sm text-sena-text-soft">Esta acción activará la sugerencia nuevamente</p>
          </div>
        </div>
        ...
        <div class="px-6 py-5">
          <p class="text-sm text-sena-text-soft leading-relaxed">
            ¿Estás seguro de que deseas habilitar la sugerencia <span class="font-semibold text-sena-text-main" id="nombre-suegerencia-habilitar">"Desarrollador Full Stack Senior"</span>?
          </p>
          <p class="text-xs text-sena-text-soft mt-3 bg-yellow-50 p-3 rounded-lg border border-yellow-200">
            <span class="font-medium text-yellow-800">Información:</span> La sugerencia volverá a estar visible y disponible para su uso.
          </p>
        </div>
