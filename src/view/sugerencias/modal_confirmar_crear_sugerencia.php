<!-- modal_confirmacion_crear_sugerencia.php -->
<!-- Modal de éxito - Sugerencia creada correctamente (desaparece en 3 segundos) -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div class="relative w-full max-w-md transform overflow-hidden rounded-xl border border-sena-border bg-white shadow-2xl transition-all animate-modalFadeIn">
        ...
        <div class="border-b border-sena-border px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-sena-text-main">¡Sugerencia Creada!</h3>
            <p class="text-sm text-sena-text-soft">La sugerencia se ha creado exitosamente</p>
          </div>
        </div>
